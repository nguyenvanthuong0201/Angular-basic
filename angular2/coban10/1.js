...
myApp.config(function ($routeProvider, $locationProvider) {
  $routeProvider
    ...
    .when("/addEmployee", { templateUrl: "views/add_employee.html" })
    .otherwise({
      redirectTo: "/",
    });
...
$scope.getSortClass=function(column){
  ...
  $http
    .get("http://127.0.0.1:8081/angular1_php/index.php/welcome/account")
    .then(function (res) {
  ...
  $scope.luusua = function (employee) {
    ...
    $http
      .post(
        "http://127.0.0.1:8081/angular1_php/index.php/welcome/luuAccount",
        data,
        config
      )
      .then(
